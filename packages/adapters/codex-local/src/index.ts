...
export const DEFAULT_CODEX_LOCAL_CHEAP_MODEL = "gpt-5.3-codex-spark";
...
- BytePlus ModelArk runs in text-only compatibility mode because ModelArk currently rejects Codex namespace tools. Paperclip disables Codex MCP/app/subagent/shell tool features for this provider and captures the final answer directly.
